...
for i 
    ...
    saverNew.save(sess, 'C:/Tulip/Machine-Learning---Real-learning/model/cifar10Withpb/hi_cifar_model')
    saverNew = tf.train.import_meta_graph('C:/Tulip/Machine-Learning---Real-learning/model/cifar10Withpb/hi_cifar_model.meta')
    saverNew.restore(sess, tf.train.latest_checkpoint('C:/Tulip/Machine-Learning---Real-learning/model/cifar10Withpb/'))
